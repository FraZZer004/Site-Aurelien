            ...
            >
                ...
                <div className="relative overflow-hidden aspect-[4/3] rounded-t-2xl">
                    ...
                    {photos.length > 1 && (
                        <>
                            ...
                            {/* Photo counter — visible sur toutes tailles d'écran */}
                            <div
                                className="
              ...
              <span className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 font-medium mb-1">
                ...
                {description}
                    ...
                    {/* Hover indicator */}
                    <div
                        className={`absolute bottom-0 left-0 h-1 bg-gradient-to-r from-orange-500 to-yellow-300 transition-all duration-500 ${
